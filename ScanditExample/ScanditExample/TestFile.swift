...
//
//public class SwiftFlutterScanditOneidPlugin: NSObject, FlutterPlugin {
...
//        registrar.register(viewFactory, withId: SwiftFlutterScanditOneidPlugin.VIEW_ID)
//    }
//
...
//        self.scanditView = ScanditView(with: (dict[ScanditPlatformView.LICENSE_KEY]! as? String)!)
//        super.init()
...
//}
//
//extension ScanditPlatformView: SBSScanDelegate, SBSOverlayControllerDidCancelDelegate {
...
//    }
//
//    public func overlayController(_ overlayController: SBSOverlayController, didCancelWithStatus status: [AnyHashable : Any]?) {
...
//
//    weak var delegate: SBSScanDelegate?
...
////        picker.view.constrainToCenter(of: self, width: 200, height: 400)
